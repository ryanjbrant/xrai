...
| Auto-fix | `_AUTO_FIX_PATTERNS.md` |
| Token tips | `_TOKEN_EFFICIENCY_COMPLETE.md` |
| Tool sync | `_OPEN_MULTIBRAIN_SYNC.md` |
...
| File | Content |
|------|---------|
| `_UNITY_UAAL_MASTER.md` | Unity as Library (iOS/Android) |
...
| `_UNITY_INTELLIGENCE_PATTERNS.md` | AI integration |
...
| `_VFX_BINDINGS_MASTER.md` | Property bindings |
...
| `_MAC_UNITY_OPTIMIZATION.md` | macOS Unity optimization |
...
| File | Content |
|------|---------|
| `_CLAUDE_CODE_MASTER.md` | CC features, workflows |
...
| `_HOLOGRAM_MASTER.md` | Recording, playback |
...
**Tags**: `#unity` `#vfx` `#ar` `#ml` `#tools` `#web` `#fix`
